...
<?php
    ...
    while($result = $sql->fetch(PDO::FETCH_ASSOC))
    {
        ...
        $data1.=        ' <label class="form-check-label" for="$data = ">';
        $data1.=         $result['Option_A'];
        $data1.=         '</label>';
        $data1.=     '</div>';
        $data1.=     '<div class="form-check">';
        $data1.=         '<input class="form-check-input" type="radio" name="question'.$index.'" value="">';
        $data1.=        ' <label class="form-check-label" for="QuestionB">';
        $data1.=         $result['Option_B'];
        $data1.=         '</label>';
        $data1.=     '</div>';
        $data1.=     '<div class="form-check">';
        $data1.=         '<input class="form-check-input" type="radio" name="question'.$index.'"value=""">';
        $data1.=         '<label class="form-check-label" for="QuestionC">';
        $data1.=         $result['Option_C'];
        $data1.=         '</label>';
        $data1.=     '</div>';
        $data1.=     '<div class="form-check">';
        $data1.=         '<input class="form-check-input" type="radio" name="question'.$index.'" value="">';
        $data1.=         '<label class="form-check-label" for="QuestionD">';
